...
namespace DynamicXAML.Views.TestSampleThree
{
    public partial class BasePageXamlTemplateOne : ContentPage, INotifyPropertyChanged
    {
        ...
        public BasePageXamlTemplateOne()
        {
            //Navigation
