...
public static BluetoothLEServices Current
{
    get { return current; }
}
private static BluetoothLEServices current;

static BluetoothLEServices()
{
    current = new BluetoothLEServices();
}
protected BluetoothLEServices()
{
    var appContext = Android.App.Application.Context;
...
{
    Console.WriteLine("BluetoothLEServices: Starting a scan for devices.");
    ...
    if (this._isScanning)
    {
        Console.WriteLine("BluetoothLEServices: Scan timeout has elapsed.");
...
{
    Console.WriteLine("BluetoothLEServices: Stopping the scan for devices.");
...
public Task<bool> StartLEBluetooth()
{
    throw new NotImplementedException();
}

public Task<bool> StopLEBluetooth()
{
    throw new NotImplementedException();
}
...
public Task<bool> DisconnectDevice()
{
    throw new NotImplementedException();
}
